...
<div class="header-steps text-center">
    <div class="row">
        <div class="step_1 small-2 small-offset-3 columns active"><a href="/"><span>1</span></a></div>
              ...
              <span class="row">
                ...
                <span class="small-2 columns">
                  ...
                  <input type="submit" value="GO">
                    ...
                    <a href="/event" class="button round" style="margin-bottom: 10px">Побачити все</a>
